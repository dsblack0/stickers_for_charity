...
public class CustomStickers {
    ...
    public String CustomStickers(@RequestParam(name="name", required=false, defaultValue = "") String name,
        ...
        HttpRequest request = HttpRequest.newBuilder()
                ...
                .method("POST", HttpRequest.BodyPublishers.ofString("{\"personalizations\":[{\"to\":[{\"email\":\"kkutti@outlook.com\"}],\"subject\":\"Custom Sticker Order\"}],\"from\":{\"email\":\"from_address@example.com\"},\"content\":[{\"type\":\"text/plain\",\"value\":\"Hello, World!\"}]}"))
                .build();
